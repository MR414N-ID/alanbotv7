...
break
case 'scbot':
reply('Bot ini Menggunakan sc dari lanox')
break
case 'runtime':
...
Lexxy.sendMessage(from, bf, image, { quoted: flexx, caption: 'Logo By Lanox Ganz' })
break
case 'girlneko':
case 'sadboy':
if (isBanned)return sticBanned(from)
...
fakethumb(buffer,'By Lanox Ganz')
fs.unlinkSync(ran)
})
break
case 'searchgrup':
...
Lexxy.sendMessage('6282271639290@s.whatsapp.net', options, text, {quoted: flexx})
Lexxy.sendMessage('6282271639290@s.whatsapp.net', options, text, {quoted: flexx})
